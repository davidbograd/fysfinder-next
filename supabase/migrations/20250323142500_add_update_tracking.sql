...
BEGIN
    ...
    IF staging_record.is_update THEN
        ...
        DELETE FROM clinic_services WHERE "clinics_id" = clinic_id;
        DELETE FROM clinic_insurances WHERE "clinics_id" = clinic_id;
    ELSE
        -- Insert new clinic
        INSERT INTO clinics (
            "klinikNavn",
    ...
    INSERT INTO clinic_services ("clinics_id", "service_id")
    SELECT 
        clinic_id,
        es.service_id
    ...
    INSERT INTO clinic_insurances ("clinics_id", "insurance_id")
    SELECT 
        clinic_id,
        ic.insurance_id
