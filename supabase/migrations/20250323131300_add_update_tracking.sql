-- Add update tracking columns to clinic_submissions_staging (up)
ALTER TABLE clinic_submissions_staging
    ADD COLUMN matched_clinic_id UUID,
    ADD COLUMN is_update BOOLEAN DEFAULT FALSE;

---- Create function to handle both new and update submissions
