-- Migration: Add suburb-level aggregate event counts for admin analytics
-- Aggregates lead clicks and views by clinic suburb (lokation)

CREATE INDEX IF NOT EXISTS idx_clinic_events_created_type_clinic
  ON clinic_events(created_at, event_type, clinic_id);
